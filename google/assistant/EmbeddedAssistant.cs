...
namespace Google.Assistant.Embedded.V1Alpha1 {
  ...
  /// <summary>Holder for reflection information generated from google/assistant/embedded/v1alpha1/embedded_assistant.proto</summary>
  public static partial class EmbeddedAssistantReflection {

    #region Descriptor
    /// <summary>File descriptor for google/assistant/embedded/v1alpha1/embedded_assistant.proto</summary>
    ...
    static EmbeddedAssistantReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Cjtnb29nbGUvYXNzaXN0YW50L2VtYmVkZGVkL3YxYWxwaGExL2VtYmVkZGVk",
            "X2Fzc2lzdGFudC5wcm90bxIiZ29vZ2xlLmFzc2lzdGFudC5lbWJlZGRlZC52",
            "MWFscGhhMRocZ29vZ2xlL2FwaS9hbm5vdGF0aW9ucy5wcm90bxoXZ29vZ2xl",
            "L3JwYy9zdGF0dXMucHJvdG8i9QEKDkNvbnZlcnNlQ29uZmlnEkoKD2F1ZGlv",
            "X2luX2NvbmZpZxgBIAEoCzIxLmdvb2dsZS5hc3Npc3RhbnQuZW1iZWRkZWQu",
            "djFhbHBoYTEuQXVkaW9JbkNvbmZpZxJMChBhdWRpb19vdXRfY29uZmlnGAIg",
            "ASgLMjIuZ29vZ2xlLmFzc2lzdGFudC5lbWJlZGRlZC52MWFscGhhMS5BdWRp",
            "b091dENvbmZpZxJJCg5jb252ZXJzZV9zdGF0ZRgDIAEoCzIxLmdvb2dsZS5h",
            "c3Npc3RhbnQuZW1iZWRkZWQudjFhbHBoYTEuQ29udmVyc2VTdGF0ZSK2AQoN",
            "QXVkaW9JbkNvbmZpZxJMCghlbmNvZGluZxgBIAEoDjI6Lmdvb2dsZS5hc3Np",
            "c3RhbnQuZW1iZWRkZWQudjFhbHBoYTEuQXVkaW9JbkNvbmZpZy5FbmNvZGlu",
            "ZxIZChFzYW1wbGVfcmF0ZV9oZXJ0ehgCIAEoBSI8CghFbmNvZGluZxIYChRF",
            "TkNPRElOR19VTlNQRUNJRklFRBAAEgwKCExJTkVBUjE2EAESCAoERkxBQxAC",
            "IuMBCg5BdWRpb091dENvbmZpZxJNCghlbmNvZGluZxgBIAEoDjI7Lmdvb2ds",
            "ZS5hc3Npc3RhbnQuZW1iZWRkZWQudjFhbHBoYTEuQXVkaW9PdXRDb25maWcu",
            "RW5jb2RpbmcSGQoRc2FtcGxlX3JhdGVfaGVydHoYAiABKAUSGQoRdm9sdW1l",
            "X3BlcmNlbnRhZ2UYAyABKAUiTAoIRW5jb2RpbmcSGAoURU5DT0RJTkdfVU5T",
            "UEVDSUZJRUQQABIMCghMSU5FQVIxNhABEgcKA01QMxACEg8KC09QVVNfSU5f",
            "T0dHEAMiKwoNQ29udmVyc2VTdGF0ZRIaChJjb252ZXJzYXRpb25fc3RhdGUY",
            "ASABKAwiHgoIQXVkaW9PdXQSEgoKYXVkaW9fZGF0YRgBIAEoDCK9AgoOQ29u",
            "dmVyc2VSZXN1bHQSGwoTc3Bva2VuX3JlcXVlc3RfdGV4dBgBIAEoCRIcChRz",
            "cG9rZW5fcmVzcG9uc2VfdGV4dBgCIAEoCRIaChJjb252ZXJzYXRpb25fc3Rh",
            "dGUYAyABKAwSWgoPbWljcm9waG9uZV9tb2RlGAQgASgOMkEuZ29vZ2xlLmFz",
            "c2lzdGFudC5lbWJlZGRlZC52MWFscGhhMS5Db252ZXJzZVJlc3VsdC5NaWNy",
            "b3Bob25lTW9kZRIZChF2b2x1bWVfcGVyY2VudGFnZRgFIAEoBSJdCg5NaWNy",
            "b3Bob25lTW9kZRIfChtNSUNST1BIT05FX01PREVfVU5TUEVDSUZJRUQQABIU",
            "ChBDTE9TRV9NSUNST1BIT05FEAESFAoQRElBTE9HX0ZPTExPV19PThACIn8K",
            "D0NvbnZlcnNlUmVxdWVzdBJECgZjb25maWcYASABKAsyMi5nb29nbGUuYXNz",
            "aXN0YW50LmVtYmVkZGVkLnYxYWxwaGExLkNvbnZlcnNlQ29uZmlnSAASEgoI",
            "YXVkaW9faW4YAiABKAxIAEISChBjb252ZXJzZV9yZXF1ZXN0IuoCChBDb252",
            "ZXJzZVJlc3BvbnNlEiMKBWVycm9yGAEgASgLMhIuZ29vZ2xlLnJwYy5TdGF0",
            "dXNIABJUCgpldmVudF90eXBlGAIgASgOMj4uZ29vZ2xlLmFzc2lzdGFudC5l",
            "bWJlZGRlZC52MWFscGhhMS5Db252ZXJzZVJlc3BvbnNlLkV2ZW50VHlwZUgA",
            "EkEKCWF1ZGlvX291dBgDIAEoCzIsLmdvb2dsZS5hc3Npc3RhbnQuZW1iZWRk",
            "ZWQudjFhbHBoYTEuQXVkaW9PdXRIABJECgZyZXN1bHQYBSABKAsyMi5nb29n",
            "bGUuYXNzaXN0YW50LmVtYmVkZGVkLnYxYWxwaGExLkNvbnZlcnNlUmVzdWx0",
            "SAAiPQoJRXZlbnRUeXBlEhoKFkVWRU5UX1RZUEVfVU5TUEVDSUZJRUQQABIU",
            "ChBFTkRfT0ZfVVRURVJBTkNFEAFCEwoRY29udmVyc2VfcmVzcG9uc2UyjgEK",
            "EUVtYmVkZGVkQXNzaXN0YW50EnkKCENvbnZlcnNlEjMuZ29vZ2xlLmFzc2lz",
            "dGFudC5lbWJlZGRlZC52MWFscGhhMS5Db252ZXJzZVJlcXVlc3QaNC5nb29n",
            "bGUuYXNzaXN0YW50LmVtYmVkZGVkLnYxYWxwaGExLkNvbnZlcnNlUmVzcG9u",
            "c2UoATABQoYBCiZjb20uZ29vZ2xlLmFzc2lzdGFudC5lbWJlZGRlZC52MWFs",
            "cGhhMUIOQXNzaXN0YW50UHJvdG9QAVpKZ29vZ2xlLmdvbGFuZy5vcmcvZ2Vu",
            "cHJvdG8vZ29vZ2xlYXBpcy9hc3Npc3RhbnQvZW1iZWRkZWQvdjFhbHBoYTE7",
            "ZW1iZWRkZWRiBnByb3RvMw=="));
  ...
  public sealed partial class ConverseConfig : pb::IMessage<ConverseConfig> {
    ...
    public ConverseConfig(ConverseConfig other) : this() {
      audioInConfig_ = other.audioInConfig_ != null ? other.audioInConfig_.Clone() : null;
      audioOutConfig_ = other.audioOutConfig_ != null ? other.audioOutConfig_.Clone() : null;
      converseState_ = other.converseState_ != null ? other.converseState_.Clone() : null;
  ...
  public sealed partial class ConverseRequest : pb::IMessage<ConverseRequest> {
    ...
    public void MergeFrom(ConverseRequest other) {
      ...
      switch (other.ConverseRequestCase) {
        case ConverseRequestOneofCase.Config:
          if (Config == null) {
            Config = new global::Google.Assistant.Embedded.V1Alpha1.ConverseConfig();
          }
  ...
  public sealed partial class ConverseResponse : pb::IMessage<ConverseResponse> {
    ...
    public void MergeFrom(ConverseResponse other) {
      ...
      switch (other.ConverseResponseCase) {
        ...
        case ConverseResponseOneofCase.AudioOut:
          if (AudioOut == null) {
            AudioOut = new global::Google.Assistant.Embedded.V1Alpha1.AudioOut();
          }
          AudioOut.MergeFrom(other.AudioOut);
          break;
        case ConverseResponseOneofCase.Result:
          if (Result == null) {
            Result = new global::Google.Assistant.Embedded.V1Alpha1.ConverseResult();
          }
